...
public class NewFolderThread extends SwingWorker<Void, Void> {
	private CloudOperations cloudHandler;
	private TransferTask task;
	private UpdatableTableModel model;
	private int transferId;
	
	public NewFolderThread(TransferTask task, CloudOperations cloudHandler,
	...
	protected Void doInBackground() throws Exception {
		try {
			...
			boolean isFolderCreated = cloudHandler.mkdir(task.getSourcePath());
			if (isFolderCreated) {
